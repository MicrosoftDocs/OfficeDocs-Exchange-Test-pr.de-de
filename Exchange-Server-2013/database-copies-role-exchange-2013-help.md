---
title: 'Rolle „Datenbankkopien&quot;: Exchange 2013 Help'
TOCTitle: Rolle „Datenbankkopien“
ms:assetid: 71a95f5b-1f75-4ae9-9ee9-515c3a19d394
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Dd876905(v=EXCHG.150)
ms:contentKeyID: 50475940
ms.date: 05/22/2018
...
Die Verwaltungsrolle `Database Copies` ermöglicht Administratoren das Hinzufügen, Entfernen, Anhalten, Fortsetzen, Anzeigen und Aktualisieren von Datenbankkopien auf einzelnen Servern.
...
Die Cmdlets **Set-MailboxDatabaseCopy** und **Remove-MailboxDatabaseCopy**, die in dieser Rolle enthalten sind, erfordern, dass sich die zu konfigurierende oder zu entfernende Datenbank innerhalb des Datenbankbereichs befindet. Außerdem muss die Datenbank auf einem Server gespeichert werden, der sich innerhalb des Serverbereichs befindet. Weitere Informationen zu Bereichen finden Sie unter [Grundlegendes zu Verwaltungsrollenbereichen](understanding-management-role-scopes-exchange-2013-help.md).
