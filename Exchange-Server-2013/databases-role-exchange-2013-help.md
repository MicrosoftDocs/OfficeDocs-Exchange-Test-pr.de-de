---
title: 'Rolle „Datenbanken&quot;: Exchange 2013 Help'
TOCTitle: Rolle „Datenbanken“
ms:assetid: 317d9945-668b-448e-963f-f7127b9b3d79
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Dd876868(v=EXCHG.150)
ms:contentKeyID: 50475418
ms.date: 05/22/2018
...
Die Verwaltungsrolle `Databases` ermöglicht Administratoren das Erstellen, Verwalten und Einbinden von Postfachdatenbanken auf einzelnen Servern sowie das Aufheben deren Einbindung.
...
Das Cmdlet **Move-DatabasePath**, das in dieser Rolle enthalten ist, erfordert, dass sich die zu konfigurierende Datenbank innerhalb des Datenbankbereichs befindet. Außerdem muss die Datenbank auf einem Server gespeichert werden, der sich innerhalb des Serverbereichs befindet.

Ferner erfordert das Cmdlet **Remove-MailboxDatabase**, das in dieser Rolle enthalten ist, dass sich die zu entfernende Datenbank entweder innerhalb des Datenbankbereichs befindet oder auf einem Server gespeichert ist, der sich innerhalb des Serverbereichs befindet. Sie können also steuern, von wem Postfachdatenbanken mithilfe von Datenbank- oder Serverbereichen entfernt werden können.

Weitere Informationen finden Sie unter [Grundlegendes zu Verwaltungsrollenbereichen](understanding-management-role-scopes-exchange-2013-help.md).
