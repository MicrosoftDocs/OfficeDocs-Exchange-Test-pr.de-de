---
title: 'Rolle „Exchange-Connectors&quot;: Exchange 2013 Help'
TOCTitle: Rolle „Exchange-Connectors“
ms:assetid: 73f98c82-bde0-443d-9bcf-274047e84e15
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Dd876908(v=EXCHG.150)
ms:contentKeyID: 50476012
ms.date: 05/22/2018
...
Die Verwaltungsrolle `Exchange Connectors` ermöglicht Administratoren das Erstellen, Ändern, Anzeigen und Entfernen von Zustellungs-Agent-Connectors.

Mit dieser Rolle können keine Sende- und Empfangsconnectors verwaltet werden. Verwenden Sie zum Verwalten von Sende- und Empfangsconnectors die Rollen "Sendeconnectors" und "Empfangsconnectors". Weitere Informationen finden Sie unter:
