---
title: 'Rolle „Exchange-Server“: Exchange 2013 Help'
TOCTitle: Rolle „Exchange-Server“
ms:assetid: 5a626746-8d23-409c-a604-7e565c429990
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Dd876887(v=EXCHG.150)
ms:contentKeyID: 50475721
ms.date: 04/24/2018
...
Die Verwaltungsrolle `Exchange Servers` ermöglicht Administratoren das Ausführen folgender Aufgaben auf einzelnen Servern :

  - Hinzufügen von Entfernen von DAGs und Konfigurieren von Datenbankkopien

  - Aktivieren, Deaktivieren und Konfigurieren von Unified Messaging-Diensten

  - Ändern der Transportkonfiguration auf Postfach- und Clientzugriffsservern

  - Aktivieren und Deaktivieren von Microsoft Outlook Anywhere auf Clientzugriffsservern

  - Ändern der Konfiguration von Postfach- und Clientzugriffsservern

  - Ändern der Outlook Anywhere-Konfiguration auf Clientzugriffsservern

  - Ändern der Konfiguration für Inhaltsfilter auf Postfachservern

  - Ändern der allgemeinen Exchange-Serverkonfiguration

  - Ändern der Konfiguration für die Serverüberwachung

  - Anzeigen der Konfiguration für jede einzelne Serverrolle
