---
title: 'Install. der Exchange 2013-Edge-Transportrolle mithilfe des Setup-Assistenten'
...
8.  Wählen Sie auf der Seite **Auswahl von Serverrollen** die Option **Edge-Transport** aus. Beachten Sie hierbei, dass Sie einem Computer, auf dem die Edge-Transport-Rolle installiert ist, keine Postfach- oder Clientzugriffsserver-Rollen hinzufügen können. Die Verwaltungstools werden bei der Installation jeder anderen Serverrolle automatisch installiert.
