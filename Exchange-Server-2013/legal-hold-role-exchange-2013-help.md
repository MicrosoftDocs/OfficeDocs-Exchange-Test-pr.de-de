---
title: 'Rolle „Gesetzliche Aufbewahrungspflicht“: Exchange 2013 Help'
TOCTitle: Rolle „Gesetzliche Aufbewahrungspflicht“
ms:assetid: c98ce8ca-3477-479a-ad23-a8e6459bc4d0
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Dd876939(v=EXCHG.150)
ms:contentKeyID: 50476682
ms.date: 04/24/2018
...
Für das in dieser Rolle enthaltene Cmdlet **Enable-Mailbox** werden nicht nur Empfängerbereiche, sondern auch Datenbankkonfigurationsbereiche festgelegt. Datenbankkonfigurationsbereiche steuern, in welchen Datenbanken über das Cmdlet neue Postfächer erstellt werden können. Die Datenbank, in der ein Postfach erstellt werden soll, muss sich innerhalb des Datenbankbereichs befinden. Diese Anforderung gilt sowohl beim Angeben einer Datenbank mithilfe des Parameters *Database* im Cmdlet **Enable-Mailbox** als auch beim Zulassen der Datenbankauswahl durch eine automatische Postfachverteilung. Weitere Informationen finden Sie unter [Grundlegendes zu Verwaltungsrollenbereichen](understanding-management-role-scopes-exchange-2013-help.md).
