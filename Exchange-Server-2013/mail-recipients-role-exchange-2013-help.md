---
title: 'Rolle „Nachrichtenempfänger&quot;: Exchange 2013 Help'
TOCTitle: Rolle „Nachrichtenempfänger“
ms:assetid: 7cf1f1c7-4f32-4446-ac04-99a7f9df2059
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Dd876911(v=EXCHG.150)
ms:contentKeyID: 50476102
ms.date: 05/22/2018
...
Die Verwaltungsrolle `Mail Recipients` ermöglicht Administratoren das Verwalten vorhandener Postfächer, E-Mail-Benutzer und E-Mail-Kontakte in einer Organisation. Das Erstellen solcher Empfänger ist mit dieser Rolle nicht möglich. Zum Erstellen muss die Rolle `Mail Recipient Creation` verwendet werden.

Dieser Rollentyp gestattet es Ihnen nicht, E-Mail-aktivierte Öffentliche Ordner oder Verteilergruppen zu verwalten. Verwenden Sie zum Verwalten solcher Objekte folgende Rollen:
...
Falls Ihre Organisation ein Modell mit geteilten Berechtigungen nutzt, bei dem die Erstellung und Verwaltung von Empfängern von verschiedenen Gruppen ausgeführt wird, weisen Sie die Rolle `Mail Recipient Creation` der Gruppe zu, die die Erstellung von Empfängern übernimmt, und die Rolle `Mail Recipients` der für die Empfängerverwaltung zuständigen Gruppe. Weitere Informationen hierzu finden Sie in den folgenden Themen:
...
Zusätzlich zu Empfängerbereichen werden die Cmdlets **Connect-Mailbox** und **Enable-Mailbox**, die in dieser Rolle enthalten sind, ebenfalls mithilfe von Datenbankkonfigurationsbereichen abgegrenzt. Datenbankkonfigurationsbereiche steuern, für welche Datenbanken die Cmdlets neue Postfächer erstellen können. Die Datenbank, in der Sie ein Postfach erstellen möchten, muss innerhalb des Datenbankbereichs liegen. Diese Bedingung trifft zu, wenn Sie eine Datenbank mithilfe des Parameters *Database* für eines der Cmdlets angeben, oder wenn Sie der automatischen Postfachverteilung gestatten, die Datenbank für Sie auszuwählen. Weitere Informationen finden Sie unter [Grundlegendes zu Verwaltungsrollenbereichen](understanding-management-role-scopes-exchange-2013-help.md).
