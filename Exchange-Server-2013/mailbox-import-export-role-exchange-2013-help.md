---
title: 'Rolle „Postfachimport/-export“: Exchange 2013 Help'
TOCTitle: Rolle „Postfachimport/-export“
ms:assetid: d7cdce7a-6c46-4750-b237-d1c1773e8d28
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Ee633482(v=EXCHG.150)
ms:contentKeyID: 50476822
ms.date: 04/24/2018
...
Die Verwaltungsrolle `Mailbox Import Export` ermöglicht Administratoren das Importieren und Exportieren von Postfachinhalten sowie das Entfernen unerwünschter Inhalte aus einem Postfach.
