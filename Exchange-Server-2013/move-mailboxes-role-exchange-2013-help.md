---
title: 'Rolle „Postfächer verschieben&quot;: Exchange 2013 Help'
TOCTitle: Rolle „Postfächer verschieben“
ms:assetid: 46576498-5d73-495b-8925-b8ce39cfa55e
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Dd876879(v=EXCHG.150)
ms:contentKeyID: 50475524
ms.date: 05/22/2018
...
Die Verwaltungsrolle `Move Mailboxes` ermöglicht Administratoren das Verschieben von Postfächern zwischen Servern einer Organisation und zwischen Servern in der lokalen Organisation und einer anderen Organisation.
...
Neben Empfängerbereichen können auch Datenbankkonfigurationsbereiche verwendet werden, um den Bereich für das in diese Rolle eingeschlossene Cmdlet **New-MoveRequest** festzulegen. Mit Datenbankkonfigurationsbereichen wird gesteuert, in welche Datenbanken das Cmdlet Postfächer verschieben kann. Die Datenbank, in die Sie ein Postfach verschieben, muss sich innerhalb des Datenbankbereichs befinden. Diese Bedingung gilt, wenn Sie eine Datenbank mit dem Parameter *TargetDatabase* des Cmdlets **New-MoveRequest** angeben oder wenn Sie zulassen, dass die Datenbank durch die automatische Postfachverteilung ausgewählt wird. Weitere Informationen finden Sie unter [Grundlegendes zu Verwaltungsrollenbereichen](understanding-management-role-scopes-exchange-2013-help.md).
