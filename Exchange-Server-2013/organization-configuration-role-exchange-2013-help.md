---
title: 'Rolle „Organisationskonfiguration“: Exchange 2013 Help'
TOCTitle: Rolle „Organisationskonfiguration“
ms:assetid: db952cc5-ef70-4366-acbb-0e292d4cbdd0
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Dd876946(v=EXCHG.150)
ms:contentKeyID: 50476856
ms.date: 04/24/2018
...
Die Verwaltungsrolle `Organization Configuration` ermöglicht Administratoren das Verwalten organisationsweiter Einstellungen. Die Konfigurationseinstellungen für eine Organisation, die über diese Rolle gesteuert werden können, umfassen u. a. Folgendes:
  ...
  - Ob MailTips für die Organisation aktiviert oder deaktiviert sind

  - URL der Homepage verwalteter Ordner

  - SMTP-Adresse und alternative E-Mail-Adressen von Microsoft Exchange-Empfängern

  - Eigenschaftenschemakonfiguration für das Ressourcenpostfach

  - Hilfe-URLs für die Exchange-Verwaltungskonsole und Microsoft Office Outlook Web App

Dieser Rollentyp umfasst nicht die Berechtigungen der `Organization Client Access`- oder `Organization Transport Settings`-Rolle.
