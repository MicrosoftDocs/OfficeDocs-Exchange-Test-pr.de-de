---
title: 'Rolle „Organisationstransporteinstellungen&quot;: Exchange 2013 Help'
TOCTitle: Rolle „Organisationstransporteinstellungen“
ms:assetid: ff4d032e-1b97-4a9d-b479-9b0d61832221
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Dd876961(v=EXCHG.150)
ms:contentKeyID: 50477159
ms.date: 05/22/2018
...
Die Verwaltungsrolle `Organization Transport Settings` ermöglicht Administratoren das Verwalten von organisationsweiten Transporteinstellungen wie Systemmeldungen, der Active Directory-Standortkonfiguration und Transportkonfigurationseinstellungen für die gesamte Exchange-Organisation.

Diese Rolle gestattet es Ihnen nicht, Empfangs- oder Sendeconnectors, Warteschlangen, Schutz, Agents, Remote- und akzeptierte Domänen oder Rollen zu erstellen oder zu verwalten. Damit die einzelnen Transportfeatures erstellt oder verwaltet werden können, muss Ihnen mindestens eine der folgenden Rollen zugewiesen sein:
