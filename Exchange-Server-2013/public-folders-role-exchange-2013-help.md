---
title: 'Rolle „Öffentliche Ordner“: Exchange 2013 Help'
TOCTitle: Rolle „Öffentliche Ordner“
ms:assetid: b858f04c-ac0b-495f-9193-8b9645781f73
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Dd876930(v=EXCHG.150)
ms:contentKeyID: 50476531
ms.date: 04/24/2018
...
Die Verwaltungsrolle `Public Folders ` ermöglicht Administratoren das Verwalten Öffentlicher Ordner in einer Organisation.

Mit dieser Rolle können Sie nicht verwalten, ob öffentliche Ordner E-Mail-aktiviert sind. Um einen Öffentlichen Ordner als E-Mail-aktiviert festzulegen, muss Ihnen eine der Rolle `Mail Enabled Public Folders ` zugeordnete Rolle zugewiesen sein. Weitere Informationen finden Sie unter [Rolle „E-Mail-fähige öffentliche Ordner“](mail-enabled-public-folders-role-exchange-2013-help.md).
