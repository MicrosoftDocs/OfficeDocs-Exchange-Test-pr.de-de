---
title: 'Rolle „Rollenverwaltung&quot;: Exchange 2013 Help'
TOCTitle: Rolle „Rollenverwaltung“
ms:assetid: 71d8553c-150d-4306-8de0-89be6efb5e40
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Dd876906(v=EXCHG.150)
ms:contentKeyID: 50475944
ms.date: 05/22/2018
...
Die Verwaltungsrolle `Role Management` ermöglicht Administratoren das Verwalten von Verwaltungsrollengruppen, Rollenzuweisungsrichtlinien und Verwaltungsrollen sowie Rolleneinträgen, -zuweisungen und -bereichen in einer Organisation.

Benutzer mit dieser Rolle können die Eigenschaften von Rollengruppen außer Kraft setzen, beliebige Rollengruppen konfigurieren und Mitglieder zu Rollengruppen hinzufügen oder aus diesen entfernen.
