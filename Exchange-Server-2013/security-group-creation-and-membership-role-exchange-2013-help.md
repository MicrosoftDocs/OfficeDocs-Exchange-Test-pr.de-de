---
title: 'Rolle „Sicherheitsgruppenerstellung und -mitgliedschaft“: Exchange 2013 Help'
TOCTitle: Rolle „Sicherheitsgruppenerstellung und -mitgliedschaft“
ms:assetid: 257eb517-339f-4895-9e08-f772408a41cf
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Dd876860(v=EXCHG.150)
ms:contentKeyID: 50475359
ms.date: 04/24/2018
...
Wenn Ihre Organisation ein geteiltes Berechtigungsmodell der rollenbasierten Zugriffssteuerung (Role based access control, RBAC) verwendet, bei dem das Erstellen und Verwalten universeller Sicherheitsgruppen durch eine andere Gruppe erfolgt als die Verwaltung der Server unter Exchange, weisen Sie die Rolle dieser Gruppe zu.

Wenn in Ihrer Organisation geteilte Berechtigungen von Active Directory aktiviert sind, wurden alle nicht delegierenden Verwaltungsrollenzuweisungen für diese Verwaltungsrolle entfernt. Wenn geteilte Active Directory-Berechtigungen aktiviert sind, können nur Active Directory-Administratoren mithilfe von Active Directory-Verwaltungstools neue Sicherheitsprinzipale wie Benutzer und Sicherheitsgruppen erstellen.

Weitere Informationen finden Sie unter [Grundlegendes zu geteilten Berechtigungen](understanding-split-permissions-exchange-2013-help.md).
