---
title: 'Rolle „Empfänger mit Leserechten&quot;: Exchange 2013 Help'
TOCTitle: Rolle „Empfänger mit Leserechten“
ms:assetid: 37e66b92-81d3-412f-b7a9-e1bb8cbeb468
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Dd876872(v=EXCHG.150)
ms:contentKeyID: 50475475
ms.date: 05/22/2018
...
Die Verwaltungsrolle `View-Only Recipients` ermöglicht Administratoren das Anzeigen der Konfiguration von Empfängern (z. B. Postfächer, E-Mail-Benutzer, E-Mail-Kontakte, Verteilergruppen und dynamische Verteilergruppen).

Diese Rolle kann mit Rollen, die der Rolle `View-Only Configuration` zugeordnet sind, kombiniert werden, um eine Rollengruppe zu erstellen, die jedes Objekt in der Organisation anzeigen kann. Weitere Informationen finden Sie unter [Rolle „Konfiguration (nur Anzeige)\&quot;](view-only-configuration-role-exchange-2013-help.md).
