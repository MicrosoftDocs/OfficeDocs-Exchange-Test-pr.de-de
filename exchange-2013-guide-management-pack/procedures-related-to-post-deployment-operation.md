...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Dn198286(v=EXCHG.150)
ms:contentKeyID: 54651572
ms.author: dstrome
ms.date: 04/03/2015
...
This topic contains the procedures that you can use as a reference when managing the Exchange Server 2013 Management Pack. For procedures related to deployment, see [Verfahren in Verbindung mit der Bereitstellung](procedures-related-to-deployment.md).
...
![Deaktivierung einer Warnung in der SCOM-Konsole](images/Dn198286.1c4f15b5-4978-4442-b26b-cc65ba577c9c(EXCHG.150).png "Deaktivierung einer Warnung in der SCOM-Konsole")
...
See the following topics for more information about the cmdlets you can use to configure monitoring overrides.
  ...
  - [Get-MonitoringItemIdentity](https://technet.microsoft.com/de-de/library/jj218668\(v=exchg.150\))
